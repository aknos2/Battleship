...
export class Gameboard {
  ...
  checkAdjacent(cellX, cellY) {
    const directions = [
      ...
      [0, 1], // Left and Right
      [-1, -1],
      [1, 1], // Top-left and Bottom-right diagonals
      [-1, 1],
      [1, -1], // Top-right and Bottom-left diagonals
    ];
  ...
  placeShip(x, y, ship, direction) {
    ...
    // Add to ships container if not already there
    if (!this.shipsContainer.some((s) => s.name === ship.name)) {
